...
5. Open:
   ...
   `Raw Dataset → ad_tech_campaign_raw_data.xlsx`
...
The Excel file included in the `Raw Dataset` folder is provided so that the dashboard can be reconnected to the data source when opened on another computer.
